...
const StudentApp = () => {
  ...
  const Header = ({ title, showBack = false, onBack, rightIcon }) => {
    return (
      <div className="bg-gradient-to-r from-blue-400 to-blue-500 text-white p-4 rounded-t-3xl">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <span className="text-sm opacity-75">9:41</span>
          </div>
  ...
  const DashboardScreen = () => {
    return (
      <div className="bg-gray-50 min-h-screen">
        <Header title="مرحباً أحمد" rightIcon={<Bell size={24} />} />
          ...
          <div className="bg-white p-4 rounded-xl shadow-sm">
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              >
                ...
                <span className="text-xs text-center">الحضور</span>
              </button>
              <button
              ...
              >
                ...
                <span className="text-xs text-center">المصروفات</span>
              </button>
            </div>
          </div>

          <div className="bg-white p-4 rounded-xl shadow-sm">
            <h2 className="text-lg font-semibold mb-3 text-right">تقدم الأسبوع</h2>
            <div className="space-y-4">
              <div className="text-right">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm text-green-600 font-medium">5/5 حضور</span>
                  <span className="font-medium">الحضور الأسبوعي</span>
                </div>
              ...
              <div className="text-right">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm text-blue-600 font-medium">8/10 مهام</span>
                  <span className="font-medium">المهام المكتملة</span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-2">
              ...
              <div className="text-right">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm text-purple-600 font-medium">3/4 مشاريع</span>
                  <span className="font-medium">المشاريع الجارية</span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-2">
    ...
    return (
      <div className="bg-gray-50 min-h-screen">
        ...
        <div className="p-4 space-y-4 overflow-y-auto pb-20">
          ...
          <div className="bg-white p-4 rounded-xl shadow-sm">
            <h2 className="text-lg font-semibold mb-3 text-right">سجل الحضور</h2>
            <div className="space-y-3">
              {[
                { subject: 'الشبكات', percentage: 80, present: 8, total: 10, absent: 2 },
                { subject: 'هندسة البرمجيات', percentage: 75, present: 9, total: 12, absent: 3 },
                { subject: 'قواعد البيانات', percentage: 90, present: 9, total: 10, absent: 1 }
              ].map((item, index) => (
                <div key={index} className="p-3 border rounded-lg">
                  <div className="flex justify-between items-center mb-2">
                    <span className={`font-medium ${item.percentage >= 80 ? 'text-green-600' : 'text-red-600'}`}>
                      {item.percentage}%
                    </span>
                    <span className="font-medium">{item.subject}</span>
                  </div>
                  <div className="flex justify-between text-sm text-gray-600">
                    <span>{item.absent} غياب</span>
                    <span>الحضور {item.present} من {item.total}</span>
                  </div>
                  <div className="mt-2">
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div
                        className={`h-2 rounded-full ${item.percentage >= 80 ? 'bg-green-500' : 'bg-red-500'}`}
  ...
  const AssignmentsScreen = () => {
    return (
      <div className="bg-gray-50 min-h-screen">
        <Header title="التكليفات الحالية" />
  ...
  const MessagesScreen = () => {
    return (
      <div className="bg-gray-50 min-h-screen">
        <Header title="المحادثات" rightIcon={<Search size={24} />} />
        ...
        <div className="p-4 overflow-y-auto pb-20">
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={index} className={`bg-white p-4 rounded-lg shadow-sm flex items-center gap-3 hover:bg-gray-50 ${chat.unread ? 'border-l-4 border-blue-500' : ''}`}>
